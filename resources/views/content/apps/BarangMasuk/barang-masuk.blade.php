...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div>
      <a href="{{ route('create.barangmasuk') }}" class="btn btn-primary me-2">
        <i class="ri-add-line me-1"></i> Tambah Barang Masuk
      </a>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $barang->keterangan }}</td>
              <td>{{ \Carbon\Carbon::parse($barang->tanggal_masuk)->format('d-m-Y') }}</td> <!-- Tambahan -->
          ...
          <td class="text-center">
            <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="{{ route('show.barangmasuk', $barang->id) }}">
